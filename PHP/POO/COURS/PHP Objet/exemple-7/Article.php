...
class Article 
{
    ...
    {
        echo "Propriété " . $name . " est modifié<br/>";
    ...
    // Appelée lors de la convertion de l'objet en chaîne
    ...
    {
        echo "Utilisation de l'objet comme méthode<br/>";
    }
